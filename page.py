...
segmentation_model = keras.models.load_model("image_segmentation.h5")
classification_model = keras.models.load_model("image_classification.h5")
...
if image_file is not None:
    ...
    prediction_clas= np.argmax(classification_model.predict(np.expand_dims(pred_im, axis=0)), axis=-1)[0]
    ...
    if prediction_clas == 0:
        prediction_clas = 'Benign'
    elif prediction_clas == 1:
        prediction_clas = 'Maligno'
    else:
        prediction_clas = 'Normal'
